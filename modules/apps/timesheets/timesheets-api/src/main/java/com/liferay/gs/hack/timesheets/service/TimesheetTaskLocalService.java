...
/**
 * Provides the local service interface for TimesheetTask. Methods of this
...
public interface TimesheetTaskLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TimesheetTaskLocalServiceUtil} to access the timesheet task local service. Add custom service methods to {@link com.liferay.gs.hack.timesheets.service.impl.TimesheetTaskLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TimesheetTask fetchTimesheetTaskByUuidAndGroupId(
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TimesheetTask getTimesheetTaskByUuidAndGroupId(
