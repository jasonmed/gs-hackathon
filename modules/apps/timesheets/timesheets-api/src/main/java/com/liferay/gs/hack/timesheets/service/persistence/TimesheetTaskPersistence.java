...
public interface TimesheetTaskPersistence extends BasePersistence<TimesheetTask> {
	...
	* @return the matching timesheet tasks
	*/
	public java.util.List<TimesheetTask> findByProjectTaskId(long projectTaskId);
	...
	* @return the range of matching timesheet tasks
	*/
	public java.util.List<TimesheetTask> findByProjectTaskId(
		long projectTaskId, int start, int end);
