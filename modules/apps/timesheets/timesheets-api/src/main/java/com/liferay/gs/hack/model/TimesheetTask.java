...
/**
 * The extended model interface for the TimesheetTask service. Represents a row in the &quot;gw_TimesheetTask&quot; database table, with each column mapped to a property of this class.
 *
 * @author Brian Wing Shun Chan
 * @see TimesheetTaskModel
 * @see com.liferay.gs.hack.model.impl.TimesheetTaskImpl
 * @see com.liferay.gs.hack.model.impl.TimesheetTaskModelImpl
 * @generated
 */
@ImplementationClassName("com.liferay.gs.hack.model.impl.TimesheetTaskImpl")
@ProviderType
public interface TimesheetTask extends TimesheetTaskModel, PersistedModel {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add methods to {@link com.liferay.gs.hack.model.impl.TimesheetTaskImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
