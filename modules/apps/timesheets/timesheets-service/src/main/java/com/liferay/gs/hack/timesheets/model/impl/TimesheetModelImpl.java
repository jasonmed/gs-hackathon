...
import com.liferay.gs.hack.timesheets.model.TimesheetModel;
import com.liferay.gs.hack.timesheets.model.TimesheetSoap;
...
/**
 * The base model implementation for the Timesheet service. Represents a row in the &quot;TS_Timesheet&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class TimesheetModelImpl extends BaseModelImpl<Timesheet>
	 ...
	 */
	public static final String TABLE_NAME = "TS_Timesheet";
	...
	public static final String TABLE_SQL_CREATE = "create table TS_Timesheet (uuid_ VARCHAR(75) null,timesheetId LONG not null primary key,groupId LONG,userId LONG,companyId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,startDate DATE null,endDate DATE null,status VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table TS_Timesheet";
	public static final String ORDER_BY_JPQL = " ORDER BY timesheet.startDate ASC";
	public static final String ORDER_BY_SQL = " ORDER BY TS_Timesheet.startDate ASC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.gs.hack.timesheets.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.gs.hack.timesheets.model.Timesheet"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.gs.hack.timesheets.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.gs.hack.timesheets.model.Timesheet"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.gs.hack.timesheets.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.gs.hack.timesheets.model.Timesheet"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.gs.hack.timesheets.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.gs.hack.timesheets.model.Timesheet"));
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.gs.hack.timesheets.model.Timesheet");
