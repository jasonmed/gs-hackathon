...
import com.liferay.gs.hack.model.ProjectTaskModel;
import com.liferay.gs.hack.model.ProjectTaskSoap;
...
/**
 * The base model implementation for the ProjectTask service. Represents a row in the &quot;GS_ProjectTask&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ProjectTaskModelImpl extends BaseModelImpl<ProjectTask>
	 ...
	 */
	public static final String TABLE_NAME = "GS_ProjectTask";
	...
	public static final String TABLE_SQL_CREATE = "create table GS_ProjectTask (uuid_ VARCHAR(75) null,projectTaskId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,projectId LONG,name VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table GS_ProjectTask";
	public static final String ORDER_BY_JPQL = " ORDER BY projectTask.name ASC";
	public static final String ORDER_BY_SQL = " ORDER BY GS_ProjectTask.name ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.gs.hack.service.util.PropsUtil.get(
				"value.object.entity.cache.enabled.com.liferay.gs.hack.model.ProjectTask"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.gs.hack.service.util.PropsUtil.get(
				"value.object.finder.cache.enabled.com.liferay.gs.hack.model.ProjectTask"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.gs.hack.service.util.PropsUtil.get(
				"value.object.column.bitmask.enabled.com.liferay.gs.hack.model.ProjectTask"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.gs.hack.service.util.PropsUtil.get(
				"lock.expiration.time.com.liferay.gs.hack.model.ProjectTask"));
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.gs.hack.model.ProjectTask");
