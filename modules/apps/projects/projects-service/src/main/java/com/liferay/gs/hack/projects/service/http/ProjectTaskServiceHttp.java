...
public class ProjectTaskServiceHttp {
	public static java.util.List<com.liferay.portal.kernel.model.Organization> getAllClients(
		...
		try {
			MethodKey methodKey = new MethodKey(ProjectTaskServiceUtil.class,
					"getAllClients", _getAllClientsParameterTypes0);
	...
	public static java.util.List<com.liferay.portal.kernel.model.Organization> getAllProjects(
		HttpPrincipal httpPrincipal, long companyId, long clientId) {
		try {
			MethodKey methodKey = new MethodKey(ProjectTaskServiceUtil.class,
	...
	private static Log _log = LogFactoryUtil.getLog(ProjectTaskServiceHttp.class);
	private static final Class<?>[] _getAllClientsParameterTypes0 = new Class[] {  };
