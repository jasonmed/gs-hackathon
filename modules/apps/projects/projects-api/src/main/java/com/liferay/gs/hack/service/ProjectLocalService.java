...
public interface ProjectLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProjectLocalServiceUtil} to access the project local service. Add custom service methods to {@link com.liferay.gs.hack.service.impl.ProjectLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Project fetchProjectByName(java.lang.String name);
	...
	*/
	public Project updateProject(long companyId, long groupId, long userId,
		long clientId, java.lang.String name, Date startDate, Date endDate,
		boolean active);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Project> getProjectsByStatus(boolean active, int start, int end);
