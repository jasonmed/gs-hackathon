 ...
 * {@link com.liferay.gs.hack.service.impl.ProjectLocalServiceImpl} and is the
 ...
 * @see com.liferay.gs.hack.service.base.ProjectLocalServiceBaseImpl
 * @see com.liferay.gs.hack.service.impl.ProjectLocalServiceImpl
 * @generated
 */
@ProviderType
public class ProjectLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.gs.hack.service.impl.ProjectLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.gs.hack.model.Project addProject(
		com.liferay.gs.hack.model.Project project) {
	...
	*/
	public static com.liferay.gs.hack.model.Project createProject(
		long projectId) {
	...
	*/
	public static com.liferay.gs.hack.model.Project deleteProject(
		com.liferay.gs.hack.model.Project project) {
	...
	*/
	...
	public static com.liferay.gs.hack.model.Project fetchProject(long projectId) {
		return getService().fetchProject(projectId);
	}

	public static com.liferay.gs.hack.model.Project fetchProjectByName(
		java.lang.String name) {
		return getService().fetchProjectByName(name);
	}
	...
	*/
	public static com.liferay.gs.hack.model.Project fetchProjectByUuidAndGroupId(
	...
	* @throws PortalException if a project with the primary key could not be found
	*/
	public static com.liferay.gs.hack.model.Project getProject(long projectId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.liferay.gs.hack.model.Project getProjectByUuidAndGroupId(
		java.lang.String uuid, long groupId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static com.liferay.gs.hack.model.Project updateProject(
		com.liferay.gs.hack.model.Project project) {
	...
	*/
	public static com.liferay.gs.hack.model.Project updateProject(
		...
		return getService()
				   .updateProject(companyId, groupId, userId, clientId, name,
	...
	*/
	...
	public static java.util.List<com.liferay.gs.hack.model.Project> getActiveProjectsByClientId(
		long clientId) {
		return getService().getActiveProjectsByClientId(clientId);
	}

	public static java.util.List<com.liferay.gs.hack.model.Project> getAllActiveProjects(
		int start, int end) {
		return getService().getAllActiveProjects(start, end);
	}

	public static java.util.List<com.liferay.gs.hack.model.Project> getAllProjectsByClientId(
		long clientId) {
		return getService().getAllProjectsByClientId(clientId);
	}
	...
	*/
	public static java.util.List<com.liferay.gs.hack.model.Project> getProjects(
		int start, int end) {
		return getService().getProjects(start, end);
	}

	public static java.util.List<com.liferay.gs.hack.model.Project> getProjectsByStatus(
		boolean active, int start, int end) {
		return getService().getProjectsByStatus(active, start, end);
	}
	...
	*/
	public static java.util.List<com.liferay.gs.hack.model.Project> getProjectsByUuidAndCompanyId(
	...
	*/
	public static java.util.List<com.liferay.gs.hack.model.Project> getProjectsByUuidAndCompanyId(
		...
		com.liferay.portal.kernel.util.OrderByComparator<com.liferay.gs.hack.model.Project> orderByComparator) {
		return getService()
