...
/**
 * Provides the local service interface for ProjectUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see ProjectUserLocalServiceUtil
...
public interface ProjectUserLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProjectUserLocalServiceUtil} to access the project user local service. Add custom service methods to {@link com.liferay.gs.hack.projects.service.impl.ProjectUserLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public ProjectUser createProjectUser(long projectUserId);
	...
	*/
	...
	public ProjectUser deleteProjectUser(ProjectUser projectUser);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public ProjectUser deleteProjectUser(long projectUserId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProjectUser fetchProjectUser(long projectUserId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProjectUser fetchProjectUserByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProjectUser getProjectUser(long projectUserId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public ProjectUser getProjectUserByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProjectUser> getProjectUsers(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<ProjectUser> getProjectUsersByUuidAndCompanyId(
