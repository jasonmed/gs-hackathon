...
public interface ProjectUserLocalService extends BaseLocalService,
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ProjectUserLocalServiceUtil} to access the project user local service. Add custom service methods to {@link com.liferay.gs.hack.service.impl.ProjectUserLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public ProjectUser updateProjectUser(long companyId, long groupId,
		long userId, long projectId, long employeeId, long roleId,
		double billRate);
