...
import com.liferay.gs.hack.clients.model.ClientModel;
import com.liferay.gs.hack.clients.model.ClientSoap;
...
/**
 * The base model implementation for the Client service. Represents a row in the &quot;CS_Client&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ClientModelImpl extends BaseModelImpl<Client>
	 ...
	 */
	public static final String TABLE_NAME = "CS_Client";
	...
	public static final String TABLE_SQL_CREATE = "create table CS_Client (uuid_ VARCHAR(75) null,clientId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,description VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table CS_Client";
	public static final String ORDER_BY_JPQL = " ORDER BY client.name ASC";
	public static final String ORDER_BY_SQL = " ORDER BY CS_Client.name ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.gs.hack.clients.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.gs.hack.clients.model.Client"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.gs.hack.clients.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.gs.hack.clients.model.Client"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.gs.hack.clients.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.gs.hack.clients.model.Client"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.gs.hack.clients.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.gs.hack.clients.model.Client"));
	...
	public Object clone() {
		...
		clientImpl.setUserId(getUserId());
		clientImpl.setUserName(getUserName());
	...
	public void resetOriginalValues() {
		...
		clientModelImpl._originalUuid = clientModelImpl._uuid;

		clientModelImpl._originalGroupId = clientModelImpl._groupId;

		clientModelImpl._setOriginalGroupId = false;

		clientModelImpl._originalCompanyId = clientModelImpl._companyId;

		clientModelImpl._setOriginalCompanyId = false;
	...
	public CacheModel<Client> toCacheModel() {
		...
		clientCacheModel.userId = getUserId();

		clientCacheModel.userName = getUserName();

		String userName = clientCacheModel.userName;

		if ((userName != null) && (userName.length() == 0)) {
			clientCacheModel.userName = null;
		}
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.gs.hack.clients.model.Client");
