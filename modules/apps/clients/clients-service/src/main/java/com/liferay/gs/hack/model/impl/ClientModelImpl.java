...
import com.liferay.gs.hack.model.ClientModel;
import com.liferay.gs.hack.model.ClientSoap;
...
/**
 * The base model implementation for the Client service. Represents a row in the &quot;gs_Client&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class ClientModelImpl extends BaseModelImpl<Client>
	 ...
	 */
	public static final String TABLE_NAME = "gs_Client";
	...
	public static final String TABLE_SQL_CREATE = "create table gs_Client (uuid_ VARCHAR(75) null,clientId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,description VARCHAR(75) null)";
	public static final String TABLE_SQL_DROP = "drop table gs_Client";
	public static final String ORDER_BY_JPQL = " ORDER BY client.name ASC";
	public static final String ORDER_BY_SQL = " ORDER BY gs_Client.name ASC";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.gs.hack.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.gs.hack.model.Client"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.gs.hack.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.gs.hack.model.Client"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.gs.hack.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.liferay.gs.hack.model.Client"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.gs.hack.service.util.ServiceProps.get(
				"lock.expiration.time.com.liferay.gs.hack.model.Client"));
	...
	public String toXmlString() {
		...
		sb.append("com.liferay.gs.hack.model.Client");
