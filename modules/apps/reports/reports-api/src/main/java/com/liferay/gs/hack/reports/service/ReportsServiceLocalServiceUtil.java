...
/**
 * Provides the local service utility for ReportsService. This utility wraps
 * {@link com.liferay.gs.hack.reports.service.impl.ReportsServiceLocalServiceImpl} and is the
 ...
 */
@ProviderType
public class ReportsServiceLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	...
	private static ServiceTracker<ReportsServiceLocalService, ReportsServiceLocalService> _serviceTracker =
		ServiceTrackerFactory.open(ReportsServiceLocalService.class);
}